...
public class MakeMoveTests {
    ...
    public void promotionMoves(ChessPiece.PieceType promotionType) throws InvalidMoveException {
        ...
        Assertions.assertNull(game.getGameBoard().getPiece(whitePromotion.getStartPosition()), pieceAtStart);
        ...
        Assertions.assertNull(game.getGameBoard().getPiece(blackPromotion.getStartPosition()), pieceAtStart);
